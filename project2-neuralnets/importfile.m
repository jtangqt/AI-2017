...
%   INITNEURALNET = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   INITNEURALNET = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   initneuralnet = importfile('init_neural_net.txt', 1, 7);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/08/14 15:53:12
